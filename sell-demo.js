...
// var sellQuote = coinify.getSellQuote(1, 'BTC', 'EUR').then((quote) => console.log(`**QUOTE** ID: ${quote.id},base amount, currency: ${quote.baseAmount / 100000000} ${quote.baseCurrency} and quote amount, currency: ${quote.quoteAmount * -.01} ${quote.quoteCurrency}`))
